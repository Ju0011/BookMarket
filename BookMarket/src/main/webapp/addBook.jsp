	...
	<div class = "text-right">
		...
		<form name="newBook" action="./processAddBook.jsp"
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="radio" name="condition" class="New"><fmt:message key="condition_New" />
					<input type="radio" name="condition" class="Old"><fmt:message key="condition_Old" />
					<input type="radio" name="condition" class="E-Book"><fmt:message key="condition_Refurbished" />
				</div>
			</div>
			<div class="form-group row">
